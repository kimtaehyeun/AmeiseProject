...
$("#addCategoryBtn").on("click", function () {
    ...
    $("#perentCategoryList").append('<input id="addCategoryInput" class="form form-control" type="text" value="새 분류 입력"> ')

    $("#perentCategoryList").find("#addCategoryInput").select();
    count++;
})
$("#perentCategoryList").on("blur", "#addCategoryInput", function () {

    if (confirm("대분류 " + $(this).val() + "를 추가하시겠습니까?")) {
        ...
        $("#perentCategoryList").find("#addCategoryInput").remove();
        count--;
    }
